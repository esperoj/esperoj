...
class Esperoj:
    ...
    def calculate_hash(self, stream: Iterator, algorithm: str = "sha256") -> str:
        ...
        """
        return self.utils.calculate_hash(stream, algorithm)

    def calculate_hash_from_url(self, url: str) -> str:
        ...
        """
        return self.utils.calculate_hash_from_url(url)
