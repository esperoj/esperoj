    ...
    def create(config: dict):
        ...
        match file_host_type:
            case "catbox":
                ...
                return Catbox(config["name"], config)

            case "file_ditch":
                from esperoj.storage.file_ditch import FileDitch

                return FileDitch(config["name"], config)

            case "filehaus":
                from esperoj.storage.filehaus import Filehaus
