# Generated by Django 5.2.5 on 2025-08-26 14:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(help_text="The main title or name of the item.", max_length=255),
                ),
                (
                    "identifier",
                    models.SlugField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "isbn_10",
                    models.CharField(blank=True, help_text="The 10-digit ISBN.", max_length=10),
                ),
                (
                    "isbn_13",
                    models.CharField(blank=True, help_text="The 13-digit ISBN.", max_length=13),
                ),
            ],
            options={
                "verbose_name": "Book",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "ordering": ["name"],
                "indexes": [
                    models.Index(fields=["identifier"], name="collection_identif_b59345_idx"),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "db_table": "file",
                "ordering": ["path"],
                "indexes": [models.Index(fields=["path"], name="file_path_59ab63_idx")],
                "constraints": [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "ordering": ["sort_name"],
                "indexes": [
                    models.Index(fields=["identifier"], name="person_identif_8bf926_idx"),
                    models.Index(fields=["sort_name"], name="person_sort_na_8b3f07_idx"),
                    models.Index(fields=["authorized_name"], name="person_authori_ebc142_idx"),
                ],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "ordering": ["name"],
                "indexes": [
                    models.Index(fields=["identifier"], name="subject_identif_95382f_idx"),
