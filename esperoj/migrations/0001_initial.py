...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        help_text="Additional metadata for the file.",
                        null=True,
                    ),
                ),
            ],
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("preservation", "Preservation Copy"),
                            ("backup", "Backup Copy"),
                            ("thumbnail", "Thumbnail"),
                            ("preview", "Preview"),
                        ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("WEBSITE", "Official Website / Personal Site / Blog"),
                            ("SOCIAL_MEDIA", "Social Media Profile"),
                            (
                                "GENERAL_DATABASE",
                                "General Database / Wiki / Encyclopedia",
                            ),
                            ("ACADEMIC_RESOURCE", "Academic Resource / Profile"),
                            (
                                "DIGITAL_CONTENT_PLATFORM",
                                "Digital Content Platform (Streaming, Purchase, Download)",
                            ),
                            ("ARCHIVAL_RESOURCE", "Archival Resource / Finding Aid"),
                            ("OTHER", "Other"),
                        ],
                        default="OTHER",
        ...
        migrations.CreateModel(
            name="HistoricalItemRelationship",
            fields=[
                (
                    "id",
                    models.UUIDField(
            ...
            options={
                "verbose_name": "historical Item Relationship",
                "verbose_name_plural": "historical Item Relationships",
                "ordering": ("-history_date", "-history_id"),
                "get_latest_by": ("history_date", "history_id"),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.AddField(
            model_name="historicalitemrelationship",
            name="from_item",
            field=models.ForeignKey(
                blank=True,
                db_constraint=False,
        ...
        migrations.AddIndex(
            model_name="itemrelationship",
            index=models.Index(
                fields=["from_item", "relationship_type", "order"],
                name="item_relati_from_it_39cdd2_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="itemrelationship",
            index=models.Index(
                fields=["to_item", "relationship_type"],
                name="item_relati_to_item_9a87da_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="itemrelationship",
